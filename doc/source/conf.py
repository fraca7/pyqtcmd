...
latex_documents = [
    (master_doc, 'pyqtcmd.tex', 'pyqtcmd Documentation',
     'Jérôme Laheurte', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyqtcmd', 'pyqtcmd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyqtcmd', 'pyqtcmd Documentation',
     author, 'pyqtcmd', 'One line description of project.',
     'Miscellaneous'),
]
